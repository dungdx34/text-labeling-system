...
try {
    ...
    // Check if this is actually a multi-document group
    if ($group['group_type'] !== 'multi') {
        header('Location: labeling.php?group_id=' . $group_id);
        exit();
    }
...
<head>
    ...
    <title>Gán nhãn đa văn bản - Text Labeling System</title>
...
<body>
    ...
    <!-- Auto-save indicator -->
    <div class="alert alert-info auto-save-indicator" id="auto-save-indicator">
        <i class="fas fa-save me-2"></i>Đang lưu tự động...
    </div>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="multi_labeling.php">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="mb-1"><strong>Loại:</strong> Đa văn bản</p>
                                <p class="mb-1"><strong>Số văn bản:</strong> <?php echo count($documents); ?></p>
                                <p class="mb-1"><strong>Upload bởi:</strong> <?php echo htmlspecialchars($group['uploaded_by_user'] ?? 'N/A'); ?></p>
                        ...
                        <div class="row">
                                        ...
                                        <div class="card document-card">
                                            <div class="card-header bg-light">
                                                <h6 class="mb-0">
                                                    ...
                                                    Văn bản #<?php echo $index + 1; ?>: <?php echo htmlspecialchars($document['title']); ?>
                                                </h6>
                                            </div>
                                            <div class="card-body">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card document-card">
                                    ...
                                    <div class="card-body">
                                        <div class="selected-sentences-list" id="selected-sentences-summary">
                                ...
                                <div class="card document-card">
                                    ...
                                    <div class="card-body p-0">
                                        <textarea class="summary-editor border-0 w-100" 
                                                  id="edited-summary" 
                                                  placeholder="Chỉnh sửa bản tóm tắt tổng hợp cho nhóm văn bản..."><?php echo htmlspecialchars($edited_summary); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        function updateSelectedSentencesDisplay() {
            ...
            selectedSentences.forEach(sentenceId => {
                ...
                if (sentenceElement) {
                    ...
                    html += `
                        <div class="selected-sentence-item">
                            <button class="remove-sentence" onclick="removeSentence('${sentenceId}')">
